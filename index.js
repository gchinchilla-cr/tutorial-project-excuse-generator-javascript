...
let index1 = Math.floor(Math.random() * (4 - 0) ) + 0;
let index2 = Math.floor(Math.random() * (4 - 0) ) + 0;
let index3 = Math.floor(Math.random() * (4 - 0) ) + 0;
let index4 = Math.floor(Math.random() * (4 - 0) ) + 0;
